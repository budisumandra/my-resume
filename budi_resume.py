...
PROJECTS = {
    "🏆 CIFAR-10 Classification with CNN": "https://github.com/budisumandra/cifar_prediction_CNN/blob/master/cifar.ipynb",
...
with col2:
    ...
    st.write(
        f"[📄 Download Certification](https://drive.google.com/drive/u/1/folders/1NcunoC1C22szCOrHc_WoKRfEFByVNumw)"
    )
